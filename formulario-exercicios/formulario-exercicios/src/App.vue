	...
	<div id="app">
		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Idade">
					<input type="number"  v-model.lazy.trim.number="usuario.idade"> <!--- modificadores v-model: lazy, trim, number IMP--->
				</Rotulo>
			...
			<div class="painel" v-else>
				...
				<Rotulo nome="Mensagem">  
					<span><pre>{{ mensagem }}</pre></span> <!--- aqui poderia ser 'style{white-space: pre}' NEW--->
				</Rotulo>
